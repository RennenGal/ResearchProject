-- Database Schema for Protein Data Collector
-- Local Development Setup

-- Create database if it doesn't exist
CREATE DATABASE IF NOT EXISTS protein_collector CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE protein_collector;
...
SELECT 'Database schema created successfully for local research' as status;